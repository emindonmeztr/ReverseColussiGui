...
namespace ReverseColussiGui
{
	...
	public class RC
	{
		...
		public static IList<int> findAll(string pattern, string source)
		{
			...
			int[][] rcBc = RectangularArrays.ReturnRectangularIntArray(65536, x.Length);
		...
		public virtual IList<int> findAll(string source)
		{
